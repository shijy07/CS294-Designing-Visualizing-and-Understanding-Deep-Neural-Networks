...
def rnn_backward(dh, cache):
  ...
  ##############################################################################
  N, T, H = dh.shape
  x, Wx, prev_h, Wh, forward = cache[T-1]
  D = x.shape[1]
  dx = np.zeros((N, T, D))
  ...
  for t in range(T-1, -1, -1):
    dx[:,t,:], dprev, dWx_t, dWh_t, db_t = rnn_step_backward(dh[:,t,:]+dprev, cache[t])
    dWx += dWx_t
    dWh += dWh_t
    db += db_t
...
def lstm_step_forward(x, prev_h, prev_c, Wx, Wh, b):
  ...
  cache = x, i, f, o, g, a, ai, af, ao, ag, Wx, Wh, b, prev_h, prev_c,  next_c, next_h
...
def lstm_step_backward(dnext_h, dnext_c, cache):
  ...
  #############################################################################
  x, i, f, o, g, a, ai, af, ao, ag, Wx, Wh, b, prev_h, prev_c,  next_c, next_h = cache
...
def lstm_backward(dh, cache):
  ...
  #############################################################################
  N, T, H = dh.shape
  x, i, f, o, g, a, ai, af, ao, ag, Wx, Wh, b, prev_h, prev_c,  next_c, next_h = cache[T-1]
  ...
  for t in range(T-1, -1, -1):
    dx[:,t,:], dprev, dprev_c, dWx_t, dWh_t, db_t = lstm_step_backward(dh[:,t,:]+dprev, dprev_c, cache[t])
    dWx += dWx_t
    dWh += dWh_t
    db += db_t
